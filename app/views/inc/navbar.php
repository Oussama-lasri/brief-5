      ...
      <div class="container">
        ...
        <div class="attr-nav">
          <ul>
            ...
            <li class="nav-setting">
              <a href="<?php echo URLROOT;?>/users/login"><span class="lnr lnr-enter"></span></a>
            </li><!--/.search-->
          </ul>
        </div><!--/.attr-nav-->
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./Index1.html"><img src="/Group 1.png" alt="SineMkt"></a>
        ...
        <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
          <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
            ...
            <li class=""><a href="<?php echo URLROOT; ?>/pages/NewArrival">new arrival</a></li>
            <li class=""><a href="<?php echo URLROOT; ?>/pages/features">features</a></li>
            <li class=""><a href="<?php echo URLROOT; ?>/page/blog">blog</a></li>
            <li class=""><a href="<?php echo URLROOT; ?>/pages/ContactUs">contact</a></li>
          </ul><!--/.nav -->
        </div><!-- /.navbar-collapse -->
      </div><!--/.container-->
    </nav><!--/nav-->
