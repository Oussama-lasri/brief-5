...
<        <link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/font-awesome.min.css">
        ...
        <!--linear icon css-->
		<link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/linearicons.css">
		...
		<link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/owl.theme.default.min.css">
		
        <!--bootstrap.min.css-->
        <link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/bootstrap.min.css">
		
		<!-- bootsnav -->
		<link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/bootsnav.css" >	
        ...
        <link rel="stylesheet" href="<?php echo URLROOT;?>/assets/css/styleConatct.css">
